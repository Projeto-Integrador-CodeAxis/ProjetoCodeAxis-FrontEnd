...
function CardCursos({curso}:CardCursosProps) {
    ...
    return (
        ...
        <div className='container_card bg-light-gray flex flex-col rounded-2xl overflow-hidden shadow m-10 border -mt-[5px]'>
            ...
            <div className='container_textos_card w-100'><img src={curso.imagem} className='h-full w-full shadow-xl object-cover' alt="Foto do Curso" /></div>
