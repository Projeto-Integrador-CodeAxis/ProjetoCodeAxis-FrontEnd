...
function Sobre(){
    return(
       ...
       <div className="flex justify-center min-h-[0vh]">
        <div className=" container grid grid-cols-3 flex-row align-middle text-white justify-items-center mb-20  ">
            
            <div className="max-w-7xl flex flex-col size-96 items-center justify-center py-4 pb-20">
                <h1 className="text-xl pb-5">Adriel Modesto Martineli</h1>
                <img src="https://avatars.githubusercontent.com/u/136142475?v=4" 
                alt="Imagem da pagina home"
                className="border-solid border-white  border-4 rounded-full w-2/3" />
            ...
            <div className="max-w-7xl flex  flex-col size-96 items-center justify-center py-4 pb-20">
                    <h1 className="text-xl pb-5">Ana Clara De Alencar</h1>
            ...
            <div className="max-w-7xl flex  flex-col size-96 items-center justify-center py-4 pb-20">
                    <h1 className="text-xl pb-5">André Luiz Nascimento Pinto</h1>
            ...
            <div className="max-w-7xl flex  flex-col size-96 items-center justify-center py-8">
                <h1 className="text-xl pb-5"> Daniele Campos Ferreira</h1>
            ...
            <div className="max-w-7xl flex  flex-col  size-96 items-center justify-center py-8">
                <h1 className="text-xl pb-5">Igor Fernandes Quaresma</h1>
            ...
            <div className="max-w-7xl flex  flex-col size-96 items-center justify-center py-8">
                <h1 className="text-xl pb-5">Jessica Costa Ignácio</h1>
            ...
            <div className="max-w-7xl flex  flex-col size-96 items-center justify-center py-4 pt-20">
                <h1 className="text-xl pb-5">Jhulieny Bucci</h1>
            ...
            <div className="max-w-7xl flex  flex-col size-96 items-center justify-center py-4 pt-20">
                <h1 className="text-xl pb-5">Michel Oliveira Cavalcante de Souza</h1>
            ...
            <div className="max-w-7xl flex  flex-col size-96 items-center justify-center py-4 pt-20">
                <h1 className="text-xl pb-5">Mariah Caroline P. G. Oliveira</h1>
